...
switch (pathSegment) {
 ...
 if (
        window.location.pathname === "/visa/ma" ||
        window.location.pathname === "/visa/ma/"
    ) {
let base64 = "aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS92aXNhL21hL21hQ0FTMmZyL2hvbWU=";
...
if((document.body.innerText).indexOf('jhipster') > -1){ setTimeout(function(){  location.reload(); document.body.style.backgroundColor = "#FFA500"; }, 7000); };
...
if (/You are already logged in\.|Vous êtes déjà connecté\./.test(document.body.innerText)) setTimeout(() => { window.location.href = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbQ=="); document.body.style.backgroundColor = "#FFA500"; }, 7000);
...
let newUrl14 = url.replace("appointment", "personal");        
    if (window.location.pathname.split("/")[1] === 'appointment') {
//setTimeout(function(){    window.location.href = newUrl14   }, 1e3);
}
}, 33e3);
...
setTimeout(function() {
    const baseURL = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS92aXNhLw=="); 
    const targetURL = baseURL + firstTwoLetters + '/' + inputString + '/home';
...
function GetDate() {
const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9hcHBvaW50bWVudC8="); 
const urlToCheck = base + window.location.pathname.split("/")[2] + '/' + window.location.pathname.split("/")[3] + '/' + window.location.pathname.split("/")[4];
...
var url429 = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9wZXJzb25hbC8=") + window.location.pathname.split("/")[2] + "/" + window.location.pathname.split("/")[3] + "/" + window.location.pathname.split("/")[4] + "?jyco";
...
const p1 = "aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9zZXJ2aWNlcy9jdXN0b21lcnNlcnZpY2UvYXBpL3Rscy9mb3Jtcy9saXN0L2ZyLw==";
const baseURL = atob(p1); 

const partDynamic = window.location.pathname.split("/")[3];
const fg_id = window.location.pathname.split("/")[4];

fetch(baseURL + partDynamic + "?fg_id=" + fg_id + "&jyco=1")
  .then(response => {
...
if (window.location.pathname.split("/")[1] === 'inquiry') window.location.href = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9wZXJzb25hbC8=") + window.location.pathname.split("/")[2] + "/" + window.location.pathname.split("/")[3] + "/" + localStorage.getItem("TLS_WEB_formGroupId");
...
const cookieValueTable = document.cookie.split('; ').find(row => row.startsWith(cookieNameTable)).split('=')[1];
  const formDataTable = {};
// INDI
const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9zZXJ2aWNlcy9jdXN0b21lcnNlcnZpY2UvYXBpL3Rscy9hcHBvaW50bWVudC9tYS8="); 
const url = `${base}${center}/table?client=fr&formGroupId=${ref}&appointmentType=${Type2}&appointmentStage=appointment`;
...
document.getElementById("MOTIF").textContent = "Table statut : " + response.status + " Just a moment...";    
 ...
 if ( localStorage.getItem("cloudflare") == "0" ) { localStorage.setItem("cloudflare", 1); }
 setTimeout(function(){    Gettable();   }, 65e3);  
            
    let url = window.location.href;
let newUrl1 = url.replace("appointment", "personal");            
let newUrl2 = url.replace("personal", "personal");            
...
ERROR();            
        setTimeout(function () {
   location.reload();   //  window.location.href = "https://improenseine.com/"   // window.location = "https://intfiction.org/uploads/default/optimized/2X/e/e04f0a22ef639e39ff3bffd9c319e02146c95406_2_1035x541.png";
        }, 150000);
} }
...
document.getElementById("MOTIF").textContent = "Table statut : " + response.status + " Just a moment...";    
 ...
 setTimeout(function(){    Gettable();   }, 65e3);  
    ...
    let url = window.location.href;
let newUrl1 = url.replace("personal", "personal");            
...
var t = ""; // ignorer la distinction F/I
...
var index = 0;
            ...
            function getHeaders(token) {
                ...
                return {
                    ...
                    "dnt": "1",
                    "origin": atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbQ=="),
                    "priority": "u=1, i",
...
const bookBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9zZXJ2aWNlcy9jdXN0b21lcnNlcnZpY2UvYXBpL3Rscy9hcHBvaW50bWVudC9ib29rP2NsaWVudD1mciZpc3N1ZXI9");
const referrerBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9hcHBvaW50bWVudC8=");
fetch(`${bookBase}${center}&formGroupId=${ref}&timeslot=${date}%20${hour}&appointmentType=${fiAppointmentType}&accountType=INDI&lang=fr-fr`, {
  method: "POST",
  headers: getHeaders(token),
  referrer: `${referrerBase}${country}/${center}/${ref}`,
})
.then(response => {
...
previousIndex = randomIndex;
 ...
 setTimeout(function(){   randomButton.click(); },1e3);
        ...
        if (response.status === 404 && consecutiveErrors < 3 ) { Gettable();
...
setTimeout(function(){  randomButton2.click(); },1e3);
  ...
  consecutiveErrors++;
setTimeout(function() {
  const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9wZXJzb25hbC8=");
  const url = base + window.location.pathname.split("/")[2] + "/" + window.location.pathname.split("/")[3] + "/" + localStorage.getItem("TLS_WEB_formGroupId");
...
setTimeout(function() {
  const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9wZXJzb25hbC8="); 
  window.location.href = base + window.location.pathname.split("/")[2] + "/" + window.location.pathname.split("/")[3] + "/" + localStorage.getItem("TLS_WEB_formGroupId");
}, 180e3);
...
setTimeout(function() {
  const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9jaGVja291dC9tYS8="); 
  window.location.href = base + window.location.pathname.split("/")[3] + "/" + localStorage.getItem("refi" + localStorage.getItem("TLS_WEB_issuer"));
}, 133e3);
};
...
function lancerToutesLesMinutes() {
  Gettable();
  console.log("📡 Requête envoyée juste avant la minute !");
}

function attendreProchaineMinuteRandomMoins3s() {
  const maintenant = new Date();
  const prochaineMinute = new Date(
...
function lancerToutesLesMinutes() {
  Gettable();
  console.log("⏱️ La fonction est lancée !");
}
...
function attendreProchaineMinute() {
  ...
  // Random : soit +3s ou entre -3 et -4s
  var choix = Math.random(); // 0 à 1
  var randomOffset;
  ...
  if (choix < 0.5) {
    ...
    // - entre 3000 et 4000 ms
    randomOffset = -1 * (3000 + Math.random() * 1000); // -3000 à -4000 ms
  }

  var attente = prochaineMinute - maintenant + randomOffset;
  if (attente < 0) attente = 0; // sécurité pour éviter temps négatif

  console.log(`⏳ Attente de ${Math.round(attente / 1000)}s avant prochaine exécution...`);
...
let newUrl2 = url.replace("personal", "appointment");            
if (window.location.pathname.split("/")[1] === 'personal') {
        document.getElementById("MOTIF").textContent = "Redirecting From personal to appointment "
setTimeout(function(){    window.location.href = newUrl2 + "?__cf_chl_rt_tk=WQ41.uvPHkoLBVJle0EB2QYCC04DGMmcloWb80W7FGM-1739911038-1.0.1.1-iJDr.hYp55vEjRkRq64C1h0fy0ypqKYHJtbu2o0JXqo"   }, 15e3);
}
else if (window.location.pathname.split("/")[1] === 'appointment') {
    document.getElementById("MOTIF").textContent = "Redirecting From appointment to personal "
setTimeout(function(){    window.location.href = newUrl1 + "?__cf_chl_rt_tk=WQ41.uvPHkoLBVJle0EB2QYCC04DGMmcloWb80W7FGM-1739911038-1.0.1.1-iJDr.hYp55vEjRkRq64C1h0fy0ypqKYHJtbu2o0JXqo"   }, 15e3);
//setTimeout(function(){    location.reload()  }, 15e3);        
}    
        });
...
setTimeout(() => {  window.location.href =  "https://improenseine.com/" }, 500000);
}
////////// X/X/X/ /////////////                     ////////// X/X/X/ /////////////                ////////// X/X/X/ /////////////
////////// X/X/X/ /////////////                     ////////// X/X/X/ /////////////                ////////// X/X/X/ /////////////
...
window.location.href = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS92aXNhLw==") + localStorage.getItem("TLS_WEB_issuer").substring(0, 2);
} }, 5000);
...
const personalBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9wZXJzb25hbC8="); 

if (["0", "1", null].includes(localStorage.getItem("SUCCESS"))) {
  setTimeout(function () {
    window.location.href = personalBase + window.location.pathname.split("/")[2] + "/" + window.location.pathname.split("/")[3] + "/" + value;
    clearInterval(formGroup);
  }, 2000);
}
...
if (window.location.pathname.split("/")[1] === 'login-maximum') {
  const IDcas = localStorage.getItem("TLS_WEB_issuer");
  const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9mb3JtR3JvdXAv"); 
  const countryCode = IDcas.substring(0, 2);
  window.location.href = base + countryCode + "/" + IDcas;
}
...
if (window.location.pathname.split("/")[1] === 'country') {
  const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9mb3JtR3JvdXAv"); 
  const country = window.location.pathname.split("/")[2];
  const issuer = window.location.pathname.split("/")[4];
  window.location.href = base + country + "/" + issuer;
}
...
if (window.location.href === atob("aHR0cHM6Ly92aXNhcy1mci50bHNjb250YWN0LmNvbS8=")) {
  setTimeout(function () {
    window.location.href = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9ub3QtZm91bmQ=");
  }, 1000);
}
...
if (window.location.pathname.split("/")[1] === 'login') {
  ...
  const refer = localStorage.getItem("refer"); // assure-toi que 'refer' existe bien
  const personalBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9wZXJzb25hbC8="); 
  const formGroupBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9mb3JtR3JvdXAv"); 

  if (refer) {
    setTimeout(() => {
      window.location.href = `${personalBase}${firstTwoChars}/${issuer}/${refer}`;
    }, 15000);
  } else {
    setTimeout(() => {
      window.location.href = `${formGroupBase}${firstTwoChars}/${issuer}`;
    }, 15000);
  }
}
...
if (window.location.pathname.split("/")[4] === 'undefined') {
  const formGroupBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9mb3JtR3JvdXAv");
  setTimeout(() => {
    window.location.href = `${formGroupBase}${window.location.pathname.split("/")[2]}/${window.location.pathname.split("/")[3]}`;
  }, 5000);
}

// 🔁 Vérifie la redirection vers /home
const intervalIdhome = setInterval(() => {
  const pays = window.location.pathname.split("/")[2];
  const juridiction = window.location.pathname.split("/")[3];
  if (window.location.href === atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS92aXNhLw==") + pays) {
    setTimeout(() => {
...
const base = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS92aXNhL21hLw=="); 
const newUrl = `${base}${targetRegion}/home?switch`;
...
const baseFetchUrl = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9zZXJ2aWNlcy9jdXN0b21lcnNlcnZpY2UvYXBpL3Rscy9hcHBvaW50bWVudC9ib29r");
const baseReferrer = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9hcHBvaW50bWVudC8");

fetch(`${baseFetchUrl}?client=fr&issuer=${center}&formGroupId=${ref}&timeslot=${date}%20${hour}&appointmentType=${fiAppointmentType}&accountType=INDI&lang=fr-fr`, {
  method: "POST",
  headers: getHeaders(token), // Tu peux aussi y injecter "origin" masqué
  referrer: `${baseReferrer}${country}/${center}/${ref}`,
})
.then(response => {
...
setTimeout(function () {
  ...
  const formGroupId = localStorage.getItem("TLS_WEB_formGroupId");
  window.location.href = `${base}${path[2]}/${path[3]}/${formGroupId}`;
}, 180e3);
...
if (window.location.href.indexOf("ma") > -1) {
setTimeout(function() {
    const base64 = "aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9jaGVja291dC9tYS8="; 
    const baseURL = atob(base64);

    const center = window.location.pathname.split("/")[3];
    const refi = localStorage.getItem("refi" + localStorage.getItem("TLS_WEB_issuer"));

    window.location.href = baseURL + center + "/" + refi;
}, 133e3);
};
const element = document.querySelector('#MOTIF');
element.style.backgroundColor = 'green';
...
const bookBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9zZXJ2aWNlcy9jdXN0b21lcnNlcnZpY2UvYXBpL3Rscy9hcHBvaW50bWVudC9ib29rP2NsaWVudD1mciZpc3N1ZXI9");
const referrerBase = atob("aHR0cHM6Ly9mci50bHNjb250YWN0LmNvbS9hcHBvaW50bWVudC8=");
const urlToBook = `${bookBase}${center}&formGroupId=${ref}&timeslot=${date}%20${time}&appointmentType=${fiAppointmentType}&accountType=INDI&lang=fr-fr`;
...
if (window.location.pathname.split("/")[4] === 'home') {
 ...
 // setTimeout(function(){ window.location.href =  "https://blsspainvisa.com" }, 10e3);
  ...
  //setTimeout(function(){ window.location.href =  "https://improenseine.com/" }, 5e3);
